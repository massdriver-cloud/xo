	...
	tests := []testData{
		...
		},
		{
			...
			want: []string{
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:ace-mutt resource_key:foo resource_name:four resource_type:random_pet]\",\"error_level\":\"error\"}}",
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:loving-zebra resource_key: resource_name:two resource_type:random_pet]\",\"error_level\":\"error\"}}",
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:moving-newt resource_key:0 resource_name:three resource_type:random_pet]\",\"error_level\":\"error\"}}",
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:steady-pegasus resource_key:1 resource_name:three resource_type:random_pet]\",\"error_level\":\"error\"}}",
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:striking-skunk resource_key: resource_name:one resource_type:random_pet]\",\"error_level\":\"error\"}}",
                ...
                "{\"metadata\":{\"timestamp\":\"2021-01-01 12:00:00.1234\",\"provisioner\":\"testaform\",\"event_type\":\"provisioner_error\"},\"payload\":{\"deployment_id\":\"id\",\"error_message\":\"data.terraform.deletion_violations[x]\",\"error_details\":\"map[resource_id:upward-ox resource_key:bar resource_name:four resource_type:random_pet]\",\"error_level\":\"error\"}}",
			},
		},
	}
